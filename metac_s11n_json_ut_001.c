...
START_TEST(union_type_json_s11n) {
	...
	/*struct6_t*/
	{
		struct6_t input_struct6 = { ._descriminator = 0, .b = {.byte = {1, 2, 3, 4}}};
	...
	{
		struct6_t input_struct6 = { ._descriminator = 1, .w = {.word = {1, 2}}};
	...
	{
		struct6_t input_struct6 = { ._descriminator = 1, .w = {.word = {1, 2}}, .w1 = {.word = {3, 4}}};
		JSON_S11N_POSITIVE_START(struct6_t, "{ \"_descriminator\": \"1\", "
				"\"w\": { \"word\": [ \"1\", \"2\" ] }, "
				"\"w1\": { \"word\": [ \"3\", \"4\" ] }, "
				"\"b2\": { \"byte\": [ 0, 0, 0, 0 ] }, \"w2\": { \"word\": [ \"0\", \"0\" ] }, \"dw2\": { \"dword\": [ \"0\" ] } }", sizeof(input_struct6), &input_struct6)
