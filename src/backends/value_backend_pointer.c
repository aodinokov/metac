...
static int metac_value_backend_with_pointer_delete(
	...
	metac_value_backend_with_pointer_clean(*pp_metac_value_backend_with_pointer);
...
static int metac_value_backend_with_pointer_unknown_object_delete(
	...
	p_metac_value_backend_with_pointer = metac_unknown_object_get_metac_value_backend_with_pointer(p_metac_unknown_object);
	...
	return metac_value_backend_with_pointer_delete(&p_metac_value_backend_with_pointer);
}
/*****************************************************************************/
...
static struct metac_value_backend_ops _metac_value_backend_with_pointer_ops = {
		.refcounter_object_ops = {
			.unknown_object_ops = {
					.metac_unknown_object_delete = 	metac_value_backend_with_pointer_unknown_object_delete,
			},
		},
		.value_get_value_backend_based_on_parent = 	metac_value_backend_with_pointer_value_get_value_backend_based_on_parent,
...
struct metac_value_backend_with_pointer * metac_value_backend_with_pointer_create(
	...
	if (metac_value_backend_init(
			&p_metac_value_backend_with_pointer->value_backend,
			&_metac_value_backend_with_pointer_ops,
			NULL) != 0) {

		msg_stderr("metac_value_backend_init failed\n");

		metac_value_backend_with_pointer_delete(&p_metac_value_backend_with_pointer);
		return NULL;
	}

	if (metac_value_backend_with_pointer_init(
