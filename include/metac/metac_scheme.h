...
metac_flag_t metac_scheme_is_value_scheme(struct metac_scheme *p_metac_scheme); /* can be any type or consist of any combination of types. Can be applied to any block */
metac_flag_t metac_scheme_is_indexable(struct metac_scheme *p_metac_scheme); /* can be used as element of array */
