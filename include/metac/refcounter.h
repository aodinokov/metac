...
struct metac_unknown_object_ops {
    int (*metac_unknown_object_snprintf)(
            struct metac_unknown_object *p_metac_unknown_object, char *str,
            size_t size);
...
/* TODO: may be we should create a separate struct metac_printable_object... but so far it seems ok even without that*/
