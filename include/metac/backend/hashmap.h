...
/**
 * Puts value for the given key in the map. Puts to *p_res pre-existing value if
 * any.
 *
 * If memory allocation fails, this function puts to *p_res NULL, the map's size
 * does not increase, and return to -(ENOMEM).
 */
